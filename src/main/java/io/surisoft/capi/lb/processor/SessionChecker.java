...
public class SessionChecker extends LoadBalancerSupport implements Traceable, CamelContextAware {
    ...
    public SessionChecker(RedisTemplate redisTemplate, String paramName, boolean isCookie) {
    ...
    private void persistProcessedIndex(StickySession stickySession) {
        if(stickySession.getParamValue() != null) {
            redisTemplate.opsForHash().put(StickySession.STICKY_SESSION, stickySession.getParamValue(), stickySession);
        }
    }
    ...
    private void deleteFailedSession(StickySession stickySession) {
        ...
        redisTemplate.opsForHash().delete(StickySession.STICKY_SESSION, stickySession.getParamValue());
    ...
    protected class State {
        ...
        public State(Exchange exchange, AsyncCallback callback, AsyncProcessor[] processors) {
            ...
            stickySession = (StickySession) redisTemplate.opsForHash().get(StickySession.STICKY_SESSION, paramValue);
